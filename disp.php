                ...
                <div class="container clearfix">
                    ...
                    <nav id="primary-menu">
                        ...
                        <ul class="one-page-menu" data-easing="easeInOutExpo" data-speed="1250" data-offset="80">
                            <li><a href="pigeontree.php" data-href="pigeontree.php"><div>Back to home page 🔙</div></a></li>
                        </ul>
            ...
            <div class="content-wrap nopadding">
                ...
                <div class="center page-section">
                    ...
                    <div class="container clearfix">
                        ...
                        <h2 id="impressum" class="divcenter bottommargin font-body" style="max-width: 700px; font-size: 40px;">Your Pigeon Tree</h2>
                            

                            <a class="button button-circle button-small button-border topmargin-sm" style="width:300px; margin: 0 auto; display:block;"href="<?php echo urldecode($_GET["file"]);?>" download>Download Pigeon Tree</a> 
                          
                            <iframe style="text-align:center;" id="frame" src="<?php echo urldecode($_GET["file"]);?>" scrolling="no" onload="resizeIframe(this)"></iframe>
